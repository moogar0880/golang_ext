...
// Returns the map inside of a GoMap instance for easier use within Go Code
...
// TODO popitem :: D.popitem() -> (k, v), remove and return some (key, value) pair as a 2-tuple; but raise KeyError if D is empty.
...
// Docstring variables
var (
	GoMapDoc = "A native Go Maping type that implements the same interface as a Python dict."
)
